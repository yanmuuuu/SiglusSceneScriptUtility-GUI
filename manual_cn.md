...
> **图形界面用户：** 若您通过 **SiglusSceneScriptUtility GUI** 使用本工具，请参阅 [instructions.md](instructions.md) 获取中文界面操作说明；仓库概览与便携版下载见 [README.md](README.md)。本手册为 CLI 完整参考。GUI 通过子进程调用 `siglus-ssu`，行为与本文档一致。
